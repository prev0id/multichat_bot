...
func (siw *ServerInterfaceWrapper) LeaveTwitchChat(w http.ResponseWriter, r *http.Request) {
	...
	err = runtime.BindStyledParameterWithOptions("simple", "chat", chi.URLParam(r, "chat"), &chat, runtime.BindStyledParameterOptions{ParamLocation: runtime.ParamLocationPath, Explode: false, Required: true})
	if err != nil {
